...
# save figure
using Compose, Cairo
draw(PNG("C:/Users/enric/Documents/TexMaker/MSc_Dissertation/figures/RGG_example.pdf", 16cm, 16cm), gplot(g, x, y))
...
# save figure
using Compose, Cairo
draw(PNG("C:/Users/enric/Documents/TexMaker/MSc_Dissertation/figures/rand_G_example.pdf", 20cm, 20cm), gplot(g_rand, layout = spring_layout))
draw(PNG("C:/Users/enric/Documents/TexMaker/MSc_Dissertation/figures/rand_G_comparison.png", 20cm, 20cm), gplot(g_rand, x, y))
